    ...
    <div className='searchOptions'>
      {!icon ? (
        ...
        >
          ...
          >
            <g id='Groupe_2148' data-name='Groupe 2148' transform='translate(1 1)'>
              <path
                id='Ligne_230'
                data-name='Ligne 230'
      ...
      {searchOptions && (
        ...
        >
          ...
          >
            ...
            <Link to='/filtered' onClick={() => setSearchOptions(false)}>
              <button>
                <img
            ...
            {/*<Link to='/filters' onClick={() => setSearchOptions(false)}>*/}
            {/*  <button>*/}
            {/*    <img*/}
