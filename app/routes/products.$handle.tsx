...
import { Money, VariantSelector, getSelectedProductOptions, CartForm, getPaginationVariables } from '@shopify/hydrogen'
...
export default function Product() {
  const { product, variants, randomProduct, metafieldRandom } = useLoaderData<typeof loader>()
  ...
  const productsFromCollection =
    product?.collections?.nodes?.length > 1
      ? product?.collections?.nodes?.find((collection: any) => collection.title !== 'All')?.products.nodes
  ...
  return (
    <>
      ...
      >
        {width < 768 && scrollPosition < 1000 && (
          <div
            ...
            style={{
              height: expanded ? calculateHeight(stickersData?.length) : '',
            }}
          >
            <button onClick={toggleExpand} className='button-expand'>
            ...
            {expanded && (
              <div className='expanded-buttons'>
                <span></span>
                {stickersData?.map((item: any, index: number) => (
                  <div key={index} className='product-menu-stickers' onClick={openLabels}>
                    <img
                ...
                {toothBrush === 'Small' ? (
                  <div className='product-menu-stickers' onClick={openSize}>
                    <img
      ...
      {width > 768 ? (
        <>
          ...
          >
            ...
            <p>
              Nous avons une multitude de styles et de pièces uniques, mais nous savons que parfois, vous cherchez
              quelque chose de très spécifique. <br />
              Si vous n’avez pas encore trouvé exactement ce que vous voulez dans notre Panel Trackt, nous sommes là
              pour vous aider.
            </p>
        ...
        <>
          <div className='product-desc'>
            <div className='product-caracteristics'>
              ...
              {product?.daterelease && <p>Date de sortie : {product?.daterelease?.value}</p>}

              {product?.colors && <p>couleurs :{parsedColors?.map((color: any) => color + ' ')}</p>}
            ...
            <div className='product-description'>
              ...
              <button className='responsive-btn-show' onClick={() => setShowText1(!showText1)}>
                {showText1 ? '-' : '+'}
              </button>
            </div>
          </div>
        ...
        <>
          {tobasket && (
            <div className='responsive-modal'>
              <button className='responsive-modal-close' onClick={toggleAddedToCart}>
              ...
              <ProductPrice selectedVariant={selectedVariant} soon={product.soon} setBasket={toggleFromChild} />
          ...
          {!tobasket && scrollPosition < 1000 && (
            <div className='choose-size'>
              <h6 onClick={() => setTobasket(!tobasket)}>Choisir ma taille</h6>
            </div>
          )}
          {scrollPosition > 1000 && (
            <div className='product-header-sticky'>
              <a href='#product-image'>
                <div className='product-header-sticky-product'>
                  <img src={product?.selectedVariant?.image?.url} alt={product?.vendor} />
      ...
      {width < 768 && stickers && (
        <div className='responsive-modal'>
          <button className='responsive-modal-close' onClick={() => setStickers(!stickers)}>
            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16'>
              <path
                id='Tracé_467'
                data-name='Tracé 467'
          ...
          <div className='stickers-responsive'>
            ...
            <div className='stickers-responsive-item'>
              ...
              <p>
                Accédez à la crème de la crème avec nos sorties « Exclusive item ». Ces articles premium définissent les
            ...
            <div className='stickers-responsive-item'>
              ...
              <p>
                Livraison immédiate, cette sélection est dédiée aux articles expédiés en 48H puisque nous possédons
            ...
            <div className='stickers-responsive-item'>
              ...
              <p>
                Offres incontournables, sélectionnées pour leur style audacieux et leurs prix avantageux. Des
                opportunités éphémères à saisir rapidement pour les amateurs de streetwear.
              </p>
            </div>
            <div className='stickers-responsive-item'>
              <img src='/product/stickers/new.png' alt='release' />
              <p>
                Soyez à l’avant-garde avec les dernières nouveautés du streetwear. Ces articles fraîchement arrivés sont
            ...
            <div className='stickers-responsive-item'>
              ...
              <p>
                Disponibles à la vente dans un avenir proche. Gardez un œil sur notre site pour ne pas manquer leur
                lancement !
              </p>
            </div>
            <div className='stickers-responsive-item'>
              ...
              <p>
                Ces articles prisés sont actuellement en rupture de stock, victimes de leur succès dans l’univers du
                streetwear. Inscrivez-vous pour être alerté de leur retour.
              </p>
            </div>
            <div className='stickers-responsive-item'>
              <img src='/product/stickers/promotion.png' alt='release' />
              <p>
                Profitez de promotions exclusives pour enrichir votre collection de streetwear. Des pièces uniques et
                des réductions alléchantes vous attendent.
              </p>
            </div>
          </div>
        </div>
...
function BreadCrumb({ product }: { product: any }) {
  ...
  const collection =
    product?.collections?.nodes?.length > 1
      ? product?.collections?.nodes?.find((collection: any) => collection.title !== 'All')?.title
  ...
  return (
    ...
    >
      ...
      >
        <p>
          <Link to={isMixte === 'Homme' ? '/filtered' : '/filtered?manwoman=' + isMixte}>{isMixte}</Link> &gt;{' '}
          <Link to={'/search?q=' + type}>{type}</Link> &gt;{' '}
          <Link to={'/search?q=' + vendor}>
            {width > 768 ? vendor : vendor?.length > 15 ? vendor.slice(0, 15) + '...' : vendor}
          </Link>{' '}
          &gt;{' '}
          <Link to={'/search?q=' + collection}>
            {width > 768 ? collection : collection?.length > 15 ? collection.slice(0, 15) + '...' : collection}
          </Link>{' '}
          &gt;{' '}
          <Link to={'/products/' + product.handle}>
            {width > 768 ? productName : productName?.length > 10 ? productName.slice(0, 10) + '...' : productName}
          </Link>
        </p>
    ...
    <div className='product-image-container'>
      <div className='product-image'>
        <div className='product-image-title'>
          ...
          <Link to={'/search?q=' + product.collections?.nodes[0].title}>
            <h2>{product.collections?.nodes[0].title === 'All' ? '' : product.collections?.nodes[0].title}</h2>
          </Link>
          {width < 768 && (
            <p
              className='product-image-name'
              style={{
                fontSize: product?.title?.length > 30 ? '40px' : '',
                lineHeight: product?.title?.length > 30 ? '35px' : '',
              }}
            >
              {product.title}
            </p>
        ...
        <div className='product-image-main'>
          <img className='product-image-main-absolute tl' alt='top left' src='/product/tl.png' />
          <img className='product-image-main-absolute tr' alt='top right' src='/product/tr.png' />
          <img className='product-image-main-absolute bl' alt='bottom left' src='/product/bl.png' />
          <img className='product-image-main-absolute br' alt='bottom right' src='/product/br.png' />
        ...
        <div
          ...
          style={{
            justifyContent: images.length <= 2 ? 'flex-start' : 'space-between',
          }}
        >
          {images.map((image: any, index: number) => (
            <div key={image?.id} className='product-image-list-item' onClick={() => setMainImage(image?.url)}>
              <div
                style={{
                  width: images.length === 3 ? '240px' : '100%',
                  height: images.length === 3 ? '160px' : '115px',
                  backgroundColor: '#fff',
                }}
              >
                <img src={image?.url} alt={image.altText} />
              </div>
              {width > 768 && <img src={codeBar[index]?.url} alt='code bar' className='product-image-list-item-code' />}
            </div>
          ))}
        </div>
      </div>
...
function ProductMain({
  ...
  const mapping = {
    ...
    promotion: product.promotion,
    release: product.release,
    ship: selectedVariant.title === 'One Size' ? product.ship : selectedVariant?.weight >= 1 && product.ship,
    soon: product.soon,
  } as any
  ...
  return (
    <div className='product-main'>
            ...
            <div className='product-main-stickers'>
                ...
                {stickersData &&
                  stickersData
                    ...
                    .map((pair: any, pairIndex: any) => (
                      <div key={pairIndex} className='pair-container'>
              ...
              {product?.toothBrush?.value && (
                <div onClick={toggleModalToothbrush}>
                  {product?.toothBrush?.value === 'Small' || product?.toothBrush?.value === 'SMALL' ? (
                    <img src='/about/little_toothbrush.png' alt='little toothbrush' className='toothbrush' />
                  ) : product?.toothBrush?.value === 'Medium' || product?.toothBrush?.value === 'MEDIUM' ? (
                    <img src='/about/medium_toothbrush.png' alt='medium toothbrush' className='toothbrush' />
                  ) : (
                    <img src='/about/over_toothbrush.png' alt='big toothbrush' className='toothbrush' />
                  )}
                </div>
              )}
            </div>
      ...
      <div className='product-main-head'>
        {width > 768 && <ProductPrice selectedVariant={selectedVariant} soon={product.soon} />}
        <Suspense fallback={<ProductForm product={product} selectedVariant={selectedVariant} variants={[]} />}>
          <Await errorElement='There was a problem loading product variants' resolve={variants}>
            {(data) => (
              <ProductForm
    ...
    <div className='modal-stickers-overlay'>
      <div className='modal-stickers'>
        ...
        <div className='modal-stickers-header'>
          ...
          >
            Nous avons classifié nos articles en trois catégories distinctes pour mieux vous aider à choisir vos tailles
            : Little, Medium et Over. Repérez ces différentes options pour trouver la coupe qui vous convient le mieux.
          </p>
        </div>
        <div className='modal-stickers-body modal-toothbrush'>
          <div
            ...
            style={
              value && {
                backgroundColor: value === 'Small' ? 'unset' : 'rgb(0 0 0 / 40%)',
              }
            }
          >
            <img src='/about/little_toothbrush.png' alt='little' />
            <h4>Little</h4>
            <p>Adapté à ceux qui aiment un style structuré. Coupe sérée.</p>
          </div>
          <div
            className='modal-stickers-body-item'
            style={
              value && {
                backgroundColor: value === 'Medium' ? 'unset' : 'rgb(0 0 0 / 40%)',
              }
            }
          >
            <img src='/about/medium_toothbrush.png' alt='medium' />
            <h4>Medium</h4>
            <p>Conçu pour ceux qui cherchent l’équilibre. Sizing universel.</p>
          </div>
          <div
            className='modal-stickers-body-item'
            style={
              value && {
                backgroundColor: value === 'Over' ? 'unset' : 'rgb(0 0 0 / 40%)',
              }
            }
          >
            <img src='/about/over_toothbrush.png' alt='over' />
            <h4>Over</h4>
            <p>Destiné à ceux qui privilégient l’espace et la liberté de mouvement.</p>
          </div>
        </div>
      </div>
    </div>
...
function ToggleModal(toggle: any) {
  ...
  const isPromotion = stickersData.find((item: any) => item.key === 'promotion')
    ...
    <div className='modal-stickers-overlay'>
      <div className='modal-stickers'>
        ...
        <div className='modal-stickers-header'>
          ...
          >
            Nos pastilles sont là pour vous guider en un clin d’œil ! Chacune d’elles est un repère visuel qui révèle
            une caractéristique clé du produit,. Utilisez ces indicateurs pour naviguer dans notre collection et
            dénicher les pièces qui correspondent à vos critères spécifiques. C’est simple, rapide et cela rend votre
            expérience d’achat chez Trackt encore plus intuitive et personnalisée.
          </p>
        </div>
        <div className='modal-stickers-body'>
          ...
          >
            <img src='/product/stickers/hotDeal.png' alt='hotDeal' />
            <p>
              Offres incontournables, sélectionnées pour leur style audacieux et leurs prix avantageux. Des opportunités
              éphémères à saisir rapidement pour les amateurs de streetwear.
            </p>
          </div>
          ...
          >
            <img src='/product/stickers/promotion.png' alt='promotion' />
            <p>
              Profitez de promotions exclusives pour enrichir votre collection de streetwear. Des pièces uniques et des
          ...
          >
            <img src='/product/stickers/ooo.png' alt='ooo' className='img-ooo' />
            <p>
              Ces articles prisés sont actuellement en rupture de stock, victimes de leur succès dans l’univers du
              streetwear. Inscrivez-vous pour être alerté de leur retour.
            </p>
...
function ProductPrice({ selectedVariant, setBasket }: any) {
  const size = selectedVariant?.selectedOptions?.find(
    (option: any) => option.name === 'Size' || option.name === 'Taille' || option.name === 'Title'
  )?.value
  const useWidth = useWindowDimensions()
  const width = useWidth.width || 1920
    ...
    <div className='product-price'>
      ...
      {selectedVariant?.soon?.value === 'true' ? (
        <div className='product-price-container'>
          <img src='/product/stickers/soon2x.png' alt='soon' className='img-ooo' />
        ...
        selectedVariant?.compareAtPrice ? (
          ...
          selectedVariant?.price && (
            <div className='product-price-container'>
              {size == undefined || size == 'OS' || size == 'One Size' || size == 'UNIVERSEL' ? (
                <img src='/product/size/os.png' alt='price' className='product-size-os' />
              ) : (
                <img
                  src={
                    `/product/size/${size.toLowerCase()?.split(' ')[0]}.png` || `/product/size/default.png` // Utilisation de l'image par défaut si l'image spécifiée n'est pas trouvée
                  }
                  alt='price'
                  style={{
        ...
        <div className='product-price-container'>
          <img src='/product/stickers/ooo.png' alt='out of stock' className='img-ooo' />
          <span>sold out</span>
        </div>
      )}
      <AddToCartButton
        disabled={!selectedVariant || !selectedVariant?.availableForSale || selectedVariant?.soon?.value === 'true'}
        lines={
          selectedVariant
            ? [
                {
        ...
        onClick={() => {
          width > 768 ? (window.location.href = window.location.href + '#cart-aside') : handleCloseBasket()
        }}
      >
        Ajouter au panier
      </AddToCartButton>
...
function ProductForm({ product, selectedVariant, variants }: { product: any; selectedVariant: any; variants: any }) {
  ...
  return (
    <div className='product-form'>
      ...
      <VariantSelector handle={product.handle} options={product.options} variants={variants}>
        {({ option }) => <ProductOptions key={option.name} option={option} variants={variants} />}
      </VariantSelector>
      {variants?.length <= 1 && (
        <div
        ...
        >
          ...
          <div>
            {variantName === 'Default Title' || variantName === 'UNIVERSEL' ? <h4>OS</h4> : <h4>{variantName}</h4>}
          </div>
          <button
...
function ProductOptions({ option, variants }: any) {
  ...
  const defaultSize = typeof window !== 'undefined' ? localStorage.getItem('selectedShoeSize') : null
  const defaultClotheSize = typeof window !== 'undefined' ? localStorage.getItem('selectedClothesSize') : null
    ...
    <div className='product-options' key={option.name}>
      ...
      <div className='product-options-grid'>
        <Swiper
          ...
          centeredSlides={true}
          initialSlide={/^\d+(\.\d+)?$/.test(sizeType) ? selectedSize : selectedClotheSize}
          className='product-swiper'
          slideToClickedSlide={true}
          onSlideChange={handleSlideChange}
          spaceBetween={-40}
        >
          {sortedValues.map(({ value, isAvailable, isActive, to }: any, index: any) => (
              ...
              {({ isActive, isPrev, isNext }) => (
                <Link
                  ...
                  style={{
                    ...
                    fontSize: isActive ? '40px' : isPrev || isNext ? '24px' : '15px',
                    opacity: isSoon === 'true' ? 0.2 : isAvailable ? 1 : 0.2,
                  }}
                >
                  {value.split(' ') ? (
                    <div
                      style={{
                        position: 'relative',
                        color:
                          variants?.find((variant: any) => variant.selectedOptions[0]?.value === value)?.weight === 1
                            ? '#a422f7'
                            : '#fff',
                      }}
                    >
                      ...
                      <span
                        style={{
                          ...
                          position: 'absolute',
                          top: '0',
                          color: variants?.find((variant: any) => variant.selectedOptions[0]?.value === value)
                            ?.availableForSale
                            ? 'white'
                            : 'red',
                        }}
