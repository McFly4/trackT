...
export default function Collection() {
  const { collection, allProducts, randomProduct, metafieldRandom } = useLoaderData<typeof loader>()
    ...
    <>
      <div
        ...
        style={{
          ...
          justifyContent: collection.products?.nodes?.length === 0 ? 'center' : '',
        }}
      >
                  ...
                  >
                    ...
                    {width > 768 ? (
                      <div className='panel-products-grid'>
                        <div className='panel-products-grid'>
                          {nodes.map((product) => (
                            <MainProduct product={product} quantity={collection.products?.nodes?.length} />
                          ))}
                        </div>
                      </div>
                    ) : (
                      <div className='responsive-products-grid'>
                        {nodes.map((product) => (
                          <MainProduct
                            isDouble={true}
                            product={product}
                            quantity={collection.products?.nodes?.length}
                          />
                        ))}
                      </div>
                    )}
